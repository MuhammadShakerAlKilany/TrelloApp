...
route
    .route("/task")
    .all(guard_1.default)
    .get(task_controller_1.getAllTask)
    .post((0, joiValidator_1.joiValidatorBody)(task_joi_1.taskJoiSchema), task_controller_1.addTask);
route
    .route("/task/:id")
    .all(guard_1.default, (0, joiValidator_1.joiValidatorParams)(task_joi_1.taskIdSchema))
    .patch((0, joiValidator_1.joiValidatorBody)(task_joi_1.taskJoiSchemaUpdate), task_controller_1.updateTask)
