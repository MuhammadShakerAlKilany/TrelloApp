...
export const addTask = tryCatchErr<TaskAdd, ResInterface<Task>>(
  async (req, res) => {
    const body = req.body;
...
export const updateTask = tryCatchErr<
  TaskUpdate,
  ResInterface<Task>,
  { id: string }
>(async (req, res) => {
...
export const deleteTask = tryCatchErr<
  never,
  ResInterface<Task>,
  { id: string }
>(async (req, res) => {
...
export const getAllTask = tryCatchErr<
  never,
  ResInterface<TaskWithUserData[] | Task[]>,
  { id: string },
  { userData?: "true" | "false"; afDed?: "true" | "false" }
>(async (req, res) => {
